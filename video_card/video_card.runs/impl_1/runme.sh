...
HD_PWD='C:/Users/dyrge/Documents/EEL4744/video_card/video_card.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log video_card.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source video_card.tcl -notrace
