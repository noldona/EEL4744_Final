...
HD_PWD='C:/Users/dyrge/Documents/EEL4744/video_card/video_card.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_card.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_card.tcl
